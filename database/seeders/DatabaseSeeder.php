...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $listingsData = [
            ['title' => 'Marketing Principles Textbook 5th Edition', 'desc' => 'Excellent condition, barely used. Perfect for first-year marketing students.', 'price' => 2500, 'cat' => $catBooks, 'loc' => $belgianLocations[0]],
            ['title' => 'MacBook Pro 13-inch 2020', 'desc' => 'Great for students. 8GB RAM, 256GB SSD. Battery health 92%.', 'price' => 75000, 'cat' => $catElectronics, 'loc' => $belgianLocations[1]],
            ['title' => 'Desk Lamp with USB Port', 'desc' => 'Modern LED desk lamp. Adjustable brightness. Includes USB charging port.', 'price' => 1500, 'cat' => $catFurniture, 'loc' => $belgianLocations[2]],
            ['title' => 'Office Chair - Ergonomic', 'desc' => 'Comfortable ergonomic chair. Lumbar support, adjustable height.', 'price' => 6000, 'cat' => $catFurniture, 'loc' => $belgianLocations[3]],
            ['title' => 'Scientific Calculator TI-84 Plus', 'desc' => 'Graphing calculator in perfect working condition. Great for math and engineering.', 'price' => 4500, 'cat' => $catElectronics, 'loc' => $belgianLocations[0]],
            ['title' => 'Winter Jacket - North Face', 'desc' => 'Size M, waterproof, warm. Used one season only.', 'price' => 8000, 'cat' => $catClothing, 'loc' => $belgianLocations[4]],
            ['title' => 'Basketball Shoes Nike - Size 42', 'desc' => 'Lightly used. Great grip and support for indoor/outdoor.', 'price' => 3500, 'cat' => $catSports, 'loc' => $belgianLocations[1]],
            ['title' => 'Bike Lock Heavy Duty', 'desc' => 'U-lock with cable extension. Very secure. Keys included.', 'price' => 2000, 'cat' => $catOther, 'loc' => $belgianLocations[5]],
            ['title' => 'Coffee Machine Nespresso', 'desc' => 'Works perfectly. Includes milk frother. No capsules included.', 'price' => 5500, 'cat' => $catOther, 'loc' => $belgianLocations[2]],
            ['title' => 'Study Notes - Financial Accounting', 'desc' => 'Complete notes for the entire semester. Clear and organized.', 'price' => 1000, 'cat' => $catBooks, 'loc' => $belgianLocations[6]],
            ['title' => 'Monitor 24 inch Dell', 'desc' => '1080p IPS display. HDMI and DisplayPort. No dead pixels.', 'price' => 9000, 'cat' => $catElectronics, 'loc' => $belgianLocations[3]],
            ['title' => 'Backpack - Eastpak', 'desc' => 'Durable backpack with laptop compartment. Slightly worn but functional.', 'price' => 2500, 'cat' => $catOther, 'loc' => $belgianLocations[7]],
            ['title' => 'Biology Lab Manual 2024', 'desc' => 'Current edition. Unused. Has all experiment protocols.', 'price' => 1800, 'cat' => $catBooks, 'loc' => $belgianLocations[0]],
            ['title' => 'Wireless Mouse Logitech', 'desc' => 'Ergonomic design. Battery included. Works great.', 'price' => 1200, 'cat' => $catElectronics, 'loc' => $belgianLocations[1]],
            ['title' => 'Yoga Mat + Weights Set', 'desc' => 'Complete home workout set. Mat + 2x 3kg dumbbells. Barely used.', 'price' => 3000, 'cat' => $catSports, 'loc' => $belgianLocations[4]],
        ];
